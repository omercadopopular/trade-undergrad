...
\begin{frame}{Last classes}
\begin{wideitemize}
    \item Specific factors model
    \item Driving force of specialization across sectors: 
    \begin{itemize}
        \item diminishing marginal returns to labor
    \end{itemize}
    \item Driving forces of specialization across countries:
    \begin{itemize}
        \item relative factor endowment intensity (land, capital)
        \item relative technologies $(Z_{i,M}, Z_{i,A})$
    \end{itemize}
\end{wideitemize}
\end{frame}
...
\begin{wideitemize}
    \item Do differences in capital endowment (rather than technology) drive international trade?
    \item<2-> Implications for the distribution of income across factors of production?
    \item<3-> What does trade integration do to difference in income across countries?
    \item<4-> Four main results of modern trade theory:
    \begin{itemize}
...
\begin{frame}{The Heckscher-Ohlin Trade Model}
    \begin{wideitemize}
        ...
        \begin{itemize}
            ...
            \item<2-> Industries differ in the intensities of factor use
            \item<3-> Countries differ in the relative endowments of factors
        \end{itemize}
    \item<4->  Comparative advantage derives from:
    \begin{itemize}
...
\begin{column}{.5\textwidth}
    ...
    \begin{wideitemize}
        \item Let's place $K_{i,g}/L_{i,g}$ on the x-axis and $w_i/r_i$ on the y-axis
    \end{wideitemize}
...
\begin{frame}{From goods prices to optimal choices}
        ...
        \begin{wideitemize}
            \item Recall:
                \begin{eqnarray*}
            P_T \times MPL_{i,T} =  P_T \times  \frac{\partial Y_{i,T}}{\partial L_{i,T}} = w_{i}, \qquad P_C \times MPL_{i,C} = P_C \times  \frac{\partial Y_{i,C}}{\partial L_{i,C}} = w_{i}
        \end{eqnarray*}
