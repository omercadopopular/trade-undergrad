...
\title[]{International Trade: Lecture 16}
...
\begin{frame}{Free entry in equilibrium}
    \begin{wideitemize}
        ...
        \item Number of units sold per firm shrinks.
    \end{wideitemize}
\end{frame}
...
\item Each country \emph{hosts} the same number of firms as before ($N^{*}=L/(\sigma\bar f)$)...
